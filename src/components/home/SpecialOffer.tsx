...
export default function SpecialOffer() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
      <div className="grid overflow-hidden bg-brand-700 text-white md:grid-cols-2">
        <div className="p-6 sm:p-8 lg:p-12">
          ...
          <Link
            ...
            className="mt-5 inline-block bg-white px-5 py-3 text-xs font-bold uppercase tracking-wider text-slate-900 transition hover:bg-brand-50 sm:mt-7"
          >
            {t("shopOffer")}
          </Link>
        </div>
